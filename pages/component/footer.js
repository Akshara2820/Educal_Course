      ...
      <Footer1>
        <div className="footer1 max-w-[1500px] text-white m-auto relative">
            ...
            <div className="border bg-blue-600  mx-[20px] p-10 rounded absolute -top-24">
              <div className="md:flex justify-around gap-24">
                ...
                <div className="md:mt-0 mt-4">
                  <button className="bg-white text-black rounded p-5 px-6">
                    Get Started
                  </button>
                </div>
              </div>
          ...
          <div className="md:grid lg:grid-cols-4 grid-cols-2  gap-5  py-40  md:mt-0 mt-60">
            <div className="py-5">
              <div>
                <img src="./educal-footer.png" alt="loading..." />
              </div>
              <div className="py-10">
              ...
              <div className="flex gap-3">
                ...
                <div className="bg-sky-400 rounded p-3">
                  {" "}
            ...
            <div>
              <div className="text-white font-bold text-[20px] py-5">
                Company
              </div>
              <div className="py-5">
                <div className="text-gray-400 hover:text-white">About</div>
                <div className="text-gray-400 hover:text-white mt-2">
                  Course
                </div>
            ...
            <div className="">
              ...
              <div className="">
                <div className="flex py-5">
                  <input
                    className=" outline-0 text-black rounded-l-lg lg:p-4 p-2"
                    placeholder="Your email address..."
                    type="text"
                  />
                  <div>
                    <button className="bg-blue-500 p-4 rounded-r-lg hover:shadow-xl">
